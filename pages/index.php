...
<div id="texto">
    ...
    <div class="pagemiddle">
        <div id="intro">         
			<h1><a href="pages/quemsomos.php">Apresentação</a></h1>
			<p>O CRR-JF é um centro vinculado à Universidade Federal de Juiz de Fora que tem como objetivos qualificar e fortalecer ações da rede de atenção a usuários de crack, álcool e outras drogas, através da Formação Permanente de profissionais da saúde, assistência social, segurança e educação. <a href="pages/quemsomos.php">Mais informações.</a></p>
              <div id="socialmedia">
        			<?php include 'libraries/socialmedia.php' ?>
           	  </div>
        </div>
