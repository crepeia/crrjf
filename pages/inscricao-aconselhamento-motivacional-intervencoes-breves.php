...
<title>Inscrição | Aconselhamento motivacional e intervenções Breves</title>
					...
					<div class="leftmenu">
		    			...
		    			<div class="pagecontent">
        					<div class="subscribeform">	
                                <h1>Aconselhamento motivacional e intervenções Breves</h1>
                                <?php include('inscricao-informacoes.php'); ?>
                                <h2> Formulário de inscrição </h2>
                                <form id="form" onsubmit="return validate(this)"  action="../libraries/insert_curso01.php" method="post">
                                            <p> Nome Completo: <br />
