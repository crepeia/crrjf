...
<title>Inscrição | Curso de Aperfeiçoamento em Crack e Outras Drogas para Profissionais Médicos na Atenção Básica</title>
					...
					<div class="leftmenu">
		    			...
		    			<div class="pagecontent">
        					<div class="subscribeform">	
                                <h1> Curso de Aperfeiçoamento em Crack e Outras Drogas para Profissionais Médicos na Atenção Básica</h1>
                                <?php include('inscricao-informacoes.php'); ?>
                                <h2> Formulário de inscrição </h2>
                                <form id="form" onsubmit="return validate(this)"  action="../libraries/insert_curso03.php" method="post">
                                            <p> Nome Completo: <br />
