...
<title>Inscrição | Gerenciamento de Casos e Reinserção Social de Usuários de Crack e Outras Drogas para Profissionais das Redes SUS e SUAS</title>
					...
					<div class="leftmenu">
		    			...
		    			<div class="pagecontent">
        					<div class="subscribeform">	
                                <h1> Gerenciamento de Casos e Reinserção Social de Usuários de Crack e Outras Drogas para Profissionais das Redes SUS e SUAS</h1>
                                <?php include('inscricao-informacoes.php'); ?>
                                <h2> Formulário de inscrição </h2>
                                <form id="form" onsubmit="return validate(this)"  action="../libraries/insert_curso02.php" method="post">
                                            <p> Nome Completo: <br />
