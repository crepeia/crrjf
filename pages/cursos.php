    	...
    	<div id="corpo"> 
            	...
            	<div class="main">
                 ...
                 <div class="lecures">
	                 ...
	                 <ul>
								<li>Os cursos estão temporariamente sem novas turmas, mas você poderá assistir as aulas resumidas disponibilizadas <a href="/pages/news/aulas-disponiveis-online-cursos-crrjf.php">aqui.</a></li>	                 	
	                 		<li>Para assistir as aulas é necessário ter o plugin flash. O download pode ser feito gratuitamente <a href="http://get.adobe.com/flashplayer/">aqui</a>.</li>
	                 </ul>
						...
						<div class="coursedescription">
                                        ...
                                        <div id="c1">
                                            ...
                                            <strong>Descrição:</strong> São abordados tópicos para correta utilização da Entrevista Motivacional e das Intervenções Breves na abordagem ao usuário de risco de substâncias, abordagens utilizadas em todo mundo para parada ou redução do consumo de drogas. <br /><input type="button" id="bc1" value="Mais informações" onclick="fade('descricao1', this)"/>  <a href="calendar.php"><input type="button" id="bc1" value="Cronograma"/></a>  <a href="inscricao-cursos-2013.php"><input type="button" id="bc1" value="Inscrição"/></a> 
														<div id="descricao1">
															...
															<ul>
																<li>Política Nacional sobre Drogas (PNAD)</li>
																<li>Política Nacional sobre o Álcool</li>
																<li>Políticas setoriais de saúde e de assistência social</li>
															</ul>				
															<h4>Redes Assistenciais</h4>
															<ul>
																<li>Rede SUS (PSF, NASF, CAPS, HG)</li>
																<li>Rede SUAS (CRAS, CREAS)</li>
																<li>A inter-relação entre rede SUS, SUAS e Redes Informais</li>
															</ul>
															<h4>Níveis de intervenção em Álcool e outras Drogas</h4>
															<ul>
																<li>Promoção da Saúde,</li>
																<li>Ações de Prevenção</li>
																<li>Ações de Tratamento e reabilitação</li>
															</ul>
															<h4>Conceito  Básicos sobre Drogas</h4>
															<ul>
																<li>Padrões de uso de substâncias psicoativas;</li>
																<li>Epidemiologia do uso de drogas</li>
																<li>Quadros Clínicos decorrentes do uso de drogas.</li>
															</ul>
															<h4>Como preparar pessoas para mudança? Entrevista Motivacional</h4>
															<ul>
																<li>O papel da motivação</li>
																<li>Aconselhamento motivacional</li>
																<li>Entrevista Motivacional e os estágios de mudança</li>
																<li>As abordagens motivacionais eficazes</li>
																<li>A correlação da Entrevista Motivacional com a Intervenção Breve</li>
																<li>As aplicações clínicas da Entrevista Motivacional</li>
																<li>A importância da Entrevista Motivacional na manutenção da mudança</li>
															...
															<h4>Intervenção Breve para uso de risco de substâncias psicoativas</h4>
															<ul>
																<li>Aspectos históricos e teóricos da Intervenção Breve</li>
																<li>Princípios básicos da Intervenção Breve</li>
																<li>Intervenção Breve: a quem se destina?</li>
																<li>Efetividade e relação custo-benefício da Intervenção Breve</li>
																<li>Como proceder no manejo da técnica de Intervenção Breve?</li>
																<li>As estratégias específicas de Intervenção Breve para cada droga específica: crack e cocaína, álcool, tabaco, maconha e outras</li>
																<li>A Intervenção Breve na prática: aplicação no contexto da Atenção Primária à Saúde (APS), serviços de emergência e hospital geral</li>
																<li>As experiências brasileiras de aplicação da Intervenção Breve na abordagem ao usuário de substâncias psicoativas</li>
                                        ...
                                        <div id="c2">
                                            ...
                                            <strong>Descrição:</strong> São abordados conteúdos essenciais para o desenvolvimento de intervenções mais efetivas com relação à prevenção, promoção e reabilitação psicossocial de usuários de substâncias psicoativas a partir da integração entre os dispositivos assistenciais e comunidade e do fortalecimento das redes sociais. <br /><input type="button" id="bc2" value="Mais informações" onclick="fade('descricao2', this)"/>  <a href="calendar.php"><input type="button" id="bc2" value="Cronograma"/>  <a href="inscricao-cursos-2013.php"><input type="button" id="bc2" value="Inscrição"/></a>
														<div id="descricao2">
															...
															<ul>
																<li>O consumo de substâncias psicoativas entre os diferentes grupos populacionais</li>
																<li>Análise dos indicadores epidemiológicos de uso de substâncias psicoativas a partir da realidade local</li>
																<li>Desenvolver programas preventivos adequados a necessidade populacional</li>
															</ul>
															<h4>Políticas sobre Drogas no Brasil</h4>
															<ul>
																<li>Breve histórico das Políticas sobre drogas no Brasil</li>
																<li>Descrição das Políticas vigentes (PNAD, PAIUAD, Crack é Possível Vencer)</li>
																<li>Formas de reverberação das políticas sobre drogas nos diferentes contextos dos profissionais do SUS e SUAS </li>
															</ul>
															<h4>Prejuízos psicossociais associados ao uso, abuso e dependência substâncias psicoativas</h4>
															<ul>
																<li>Problemas médicos associados ao uso de substâncias psicoativas</li>
																<li>Prejuízos psicológicos associados ao uso de substâncias psicoativas</li>
																<li>Danos sociais relacionados ao uso de substâncias psicoativas</li>
															</ul>
															<h4>Estratégias de rastreamento de usuários de substâncias psicoativas</h4>
															<ul>
																<li>Critérios diagnósticos para uso nocivo e dependência de substâncias</li>
																<li>Realizar triagens a partir da aplicação de instrumentos de rastreo para a população adulta e adolescente</li>
																<li>Discutir os principais aspectos associados à prática da triagem ao uso abusivo de drogas enquanto rotina de trabalho</li>
																<li>Identificar os principais fatores de risco para uso de substâncias em diferentes grupos populacionais</li>
															</ul>
															<h4>Prejuízos psicossociais associados ao uso, abuso e dependência substâncias psicoativas</h4>
															<ul>
																<li>Problemas médicos associados ao uso de substâncias psicoativas</li>
															...
															<h4>Construção de redes sociais a partir dos recursos comunitários</h4>														
															<ul>
																<li>Identificar recursos comunitários para a prevenção e reabilitação psicossocial a partir de diagnóstico psicossocial</li>
																<li>Mobilização social para o fortalecimento dos recursos comunitários</li>
																<li>Estratégias locais para a implementação de ações de prevenção, promoção e reabilitação psicossocial</li>
																<li>Estratégias de integração entre os dispositivos assistenciais presentes na comunidade como: saúde, educação e assistência social</li>
															</ul>													
															<h4>Análise das estratégias de reinserção social do usuário de substâncias psicoativas</h4>														
															<ul>
																<li>Avaliação social do usuário de substâncias psicoativas</li>
																<li>Potencialidades psicossociais dos indivíduos para a realização de um projeto de vida</li>
																<li>O papel da família como fator de proteção e recuperação do usuário de substâncias psicoativas</li>
															</ul>
                                          ...
                                          <div id="descricao3">
															...
															<ul>
																...
																<li>Fundamentos de farmacoterapia</li>
                                        ...
                                        <div id="c4">
                                          ...
                                          <div id="descricao4">
															...
															<h3>Caracterização do efeito de álcool, cocaína e crack</h3>
															<ul>
																<li>Descrever o modo de ação das principais drogas psicoativas, seus efeitos agudos e crônicos</li>
																<li>Definir os mecanismos de reforço e recompensa das drogas de abuso</li>
																<li>Discutir os principais problemas médicos, psicológicos e sociais associados ao uso abusivo de drogas</li>
															</ul>
															<h3>Politicas Públicas sobre Álcool e Outras Drogas</h3>
															<ul>
																<li>A Política de Saúde Brasileira</li>
																<li>A inserção do uso de álcool e outras drogas na agenda das políticas de saúde brasileiras</li>
																<li>As políticas da SENAD</li>
																<li>A Política de Saúde Mental do Ministério da Saúde e a Política para a área de álcool e drogas</li>
																<li>A implementação das políticas brasileiras sobre álcool e drogas</li>
															</ul>

															<h3>Estratégias de Redução de Danos para o consumo de drogas</h3>
															<ul>
																<li>Discutir o papel da política de redução de danos</li>
																<li>Conhecer os modelos de abordagem do uso de drogas</li>
																<li>Conhecer os princípios da redução de danos como prática de prevenção e tratamento</li>
																<li>Compreender as práticas de redução de danos para os diferentes tipos de drogas</li>
															</ul>

															<h3>Estratégias de Triagem e Intervenção Breve (IB) para o consumo de drogas</h3>
															<ul>
																<li>Discussão de critérios diagnósticos (CID-10 e DSM-IV)</li>
																<li>Apresentar os instrumentos para detecção dos diferentes padrões de uso de substâncias.</li>
																<li>Discutir habilidades para a prática da triagem e para a incorporação da mesma na rotina de trabalho</li>
																<li>Conhecer o histórico e princípios das Intervenções Breves</li>
																<li>Analisar as condições de aplicação da IB no contexto hospitalar</li>
																<li>Descrição de experiências brasileiras e avaliação de custo-benefício da IB</li>
															</ul>
															<h3>Agravos e repercussões clínicas do uso abusivo de álcool, crack e cocaína</h3>
															<ul>
																<li>Distinguir os agravos agudos e crônicos do uso abusivo de drogas</li>
																<li>Identificar as Repercussões Clínicas  dos distintos padrões</li>
																<li>Conhecer os Fundamentos de Psicopatologia</li>
																<li>Compreender o conceito de Comorbidades e sua importância clínica</li>
															</ul>															
															<h3>Conduta clínica geral e tratamento medicamentoso</h3>
															<ul>
																<li>Identificar os indicadores clínicos dos  diferentes padrões de abuso</li>
																<li>Condutas clínicas gerais e tratamento medicamentoso da intoxicação, uso abusivo e abstinência de drogas </li>
																<li>Conhecer os Fundamentos de Farmacoterapia</li>
																<li>Critérios Clínicos para internação e alta de pacientes</li>
															</ul>
															
															<h3>O papel da Rede de atenção em Saúde Mental para prevenção, promoção e reabilitação de usuários de substâncias Psicoativas</h3>
															<ul>
																<li>Desenvolvimento de estratégias de integração entre os dispositivos de saúde mental, hospitais e o Programa Saúde da Família</li>
																<li>O papel de diferentes setores na rede de assistência: UBS, CAPSad, hospitais gerais, CRAS, casas de acolhimento, comunidades terapêuticas.</li>
																<li>A importância do envolvimento comunitário e familiar no fortalecimento de fatores de proteção e recuperação de usuários de substâncias</li>
															</ul>
															<h3>Abordagens familiares para usuários de drogas</h3>
															<ul>
																<li>Fatores de risco e proteção</li>
																<li>O papel da família como fator de proteção e recuperação do usuário de substâncias psicoativas</li>
																<li>Estratégias eficazes para abordagem do adolescente</li>
															</ul>	
                                          </div>  
                                        </div>   
                                         ...
                                         <div id="c5">
                                          ...
                                          <h3>Ementa:</h3>
														...
														<h4>Conceitos sobre drogas</h4>
														<ul>
														<li>Padrões de uso (intoxicação aguda, uso crônico, uso nocivo, dependência, abstinência)</li>
														<li>Epidemiologia do uso de drogas no Brasil e no mundo</li>
														</ul>
														<h4>Adolescentes e o consumo de drogas no contexto da justiça</h4>
														<ul>
															<li>Adolescentes, Drogas, lei e poder Judiciário: desafios  e conflitos</li>
															<li>Modelos de prevenção</li>
															<li>Estratégias de prevenção na escola</li>
														</ul>
														...
														<ul>
															...
															<li>Redução de danos</li>
															<li>Reinserção social</li>
															<li>Abordagem dos familiares do usuário de crack e outras drogas</li>
														</ul>
                                          </div>
                                        </div>
